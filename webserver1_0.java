...
public class webserver1_0 {
   ...
   private static class ServiceThread extends Thread {
	   ...
	   try {
		   ...
		   request = is.readLine();
	           System.out.println("is received: " + request);
	       }
	       ...
	       os.newLine();
    	       os.write("Server: SimpleWebServer");
	       os.newLine();
	       ...
	       os.newLine();
    	       ...
    	       os.write("<CENTER>");
	       os.newLine();
    	       os.write("<H1 style='color:red'>Welcome to SimpleWebServer<H1>");
	       os.newLine();
               os.write("</CENTER>");
	       os.newLine();
               // Đẩy dữ liệu đi
               os.flush();
	       System.out.println("os flushes: " + line);
